...
const AboutUs = () => {
  const teamMembers = [
    ...
    },
    {
      ...
      image: "/mote.jpg", // Replace with actual image
    },
    {
      name: "Akhilesh Verma",
  ...
  return (
    <div className="min-h-screen mt-5 bg-gradient-to-tr pt-20 from-blue-900 via-purple-700 to-pink-600 p-10 text-white">
      {/* Heading Section */}
      <motion.div
