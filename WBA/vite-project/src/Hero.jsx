    ...
    <div className="w-full h-screen bg-gradient-to-br from-blue-100 to-indigo-200 ">
      ...
      <section className="h-screen  pt-[6rem] md:pt-[3rem] flex flex-col md:flex-row items-center justify-center text-center px-4">
        ...
        >
          ...
          <Link to="/whiteboard" className="bg-indigo-600 text-white py-3 px-6 rounded shadow-lg hover:bg-indigo-700 transition font-semibold"> Start Drawing Now</Link>
        </motion.div>
        <motion.img
          src="/hero.avif" // Replace with a modern whiteboard illustration
          alt="Whiteboard illustration"
          initial={{ opacity: 0, scale: 0.8 }}
          animate={{ opacity: 1, scale: 1 }}
          transition={{ duration: 1, delay: 0.5 }}
          className="mt-10 rounded-full shadow-2xl md:ml-10"
        />
      </section>
